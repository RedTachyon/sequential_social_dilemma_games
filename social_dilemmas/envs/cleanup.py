...
CLEANUP_COLORS = {
    ...
    b"S": np.array([99, 156, 194], dtype=np.uint8),  # Light grey-blue stream cell  ### Actually originally brown-ish stream, now changed to blue-ish stream
    b"H": np.array([99, 156, 194], dtype=np.uint8),  # Brown waste cells ### Actually light-blue river
    b"R": np.array([113, 75, 24], dtype=np.uint8),  # Light grey-blue river cell ### Actually brown-ish waste
}
